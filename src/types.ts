export interface TargetPrice {
  ...
  price: number;
  currency: string;
  price_original?: string | undefined; // valor original extraído do texto
}
...
export interface Range {
  ...
  max: number;
  currency: string;
  min_original?: string | undefined; // valor original extraído do texto
  max_original?: string | undefined; // valor original extraído do texto
}
